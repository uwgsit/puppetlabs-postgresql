...
class postgresql::server (
  ...
  # DEBUG
  notify { "postgresql::server service_enable = ${service_enable} service_ensure = ${service_ensure} service_manage = ${service_manage} service_name = ${service_name} manage_datadir = ${manage_datadir}": }
